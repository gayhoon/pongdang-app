...
const Login = () => {
  ...
  const handleLogin = () => {
    ...
    const kakaoRedirectUri = isMobile
    ? "https://pongdangserver.shop/auth/callback"
    : process.env.NEXT_PUBLIC_REDIRECT_URI;

    const kakaoAuthURL = `https://kauth.kakao.com/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_KAKAO_REST_API_KEY}&redirect_uri=${kakaoRedirectUri}&response_type=code`;
    window.location.href = kakaoAuthURL;
  };
    ...
    <div className={styles.login_wrap}>
        ...
        <div className={styles.login_min}>
            ...
            <div className={styles.select_sns}>
                ...
                <ul>
                    <li><button type="button" className={styles.kakao} onClick={handleLogin}><IcSnsKakao /></button></li>
                    <li><button type="button" className={styles.naver} disabled><IcSnsNaver /></button></li>
                    <li><button type="button" className={styles.apple} disabled><IcSnsApple /></button></li>
                    <li><button type="button" className={styles.google} disabled><IcSnsGoogle /></button></li>
                </ul>
            </div>
        </div>
    </div>
